...
<section className={`dataStatus ${providerStatus.mode}`}><div><span className="statusDot"/><strong>{providerStatus.mode==="live"?"Live data mode":"Demo data mode"}</strong><small>{providerStatus.label}</small></div><div className="statusChips"><span className={providerStatus.currentQuote?"liveChip":"demoChip"}>Current quote · {providerStatus.currentQuote?"live":"demo"}</span><span className={providerStatus.historicalPrices?"liveChip":"demoChip"}>Price history · {providerStatus.historicalPrices?"live":"demo"}</span><span className={providerStatus.metadata?"liveChip":"demoChip"}>Fund metadata · {providerStatus.metadata?"live":"curated"}</span><span className={providerStatus.holdings?"liveChip":"demoChip"}>Holdings · {providerStatus.holdings?"live":"curated"}</span><span className={providerStatus.flows?"liveChip":"demoChip"}>Flows · {providerStatus.flows?"live":"demo"}</span></div></section>
